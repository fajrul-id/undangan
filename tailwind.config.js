...
module.exports = {
    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                "invited": `linear-gradient(to bottom, rgba(35, 162, 168, 0.52), rgba(22, 64, 97, 0.73)),url(/heronew.jpg)`,
    ...
    plugins: [
        plugin(function ({
            ...
            const utilities = {
                ".bg-hero": {
                    "background-image": "linear-gradient(to bottom, rgba(35, 162, 168, 0.52), rgba(22, 64, 97, 0.73)),url(/bgg.jpg)",
                }
            }
