    ...
    <>
      <div className={"bg-invited min-h-screen bg-cover bg-bottom pb-10"}>
        <div className={"text-center" + " opacity-100"}>
          ...
          <h1
            className={
              "md:text-6xl text-5xl md:mb-0 font-medium text-gray-100 leading-relaxed font-curs"
            }
          >
            Hello,
          ...
          <h1
            className={
              "md:text-2xl text-xl font-medium text-gray-100 leading-relaxed"
            }
          >
            - Save the date of our wedding. -
          </h1>
          <p className={"text-gray-100"}>Minggu. 17 September 2023</p>
          <br />
          <input
            type="text"
            ...
            className={
              "font-curs text-5xl md:w-[600px] w-[300px] appearance-none border-none bg-white rounded py-3 text-center " +
              "justify-center leading-tight focus:outline-none text-black capitalize"
            }
          />
          {valid ? (
            <p className="text-red-500 text-xs italic">
              Silahkan isi daftar tamu terlebih dahulu.
            </p>
          ) : null}
          <br />
          <br />
