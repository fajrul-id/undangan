      ...
      <div className={"container mx-auto hidden md:block"}>
        <div className={"flex flex-wrap text-center mt-10 pb-10"}>
          <div className={"md:w-6/12 w-full "}>
            ...
            <h1
              className={
                "md:text-5xl text-4xl font-medium text-white leading-relaxed mt-5"
              }
            >
              - Fajrul -
            </h1>
            <h1
              className={
                "md:text-4xl text-3xl font-medium text-white leading-relaxed mt-5 font-curs"
              }
            >
